...
Git Reference — это быстрый гайд по основным командам системы с примерами их использования и опциями.

Git wiki — это официальная энциклопедия по Git. 

Try Git — это интерактивное руководство от GitHub
